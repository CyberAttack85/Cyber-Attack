...
#method1
hehe = "[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097175;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/H2O;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SAMSUNG-SGH-I337;FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;]"

haji = "[FBAN/Orca-Android;FBAV/438.0.0.26.115;FBPN/com.facebook.orca;FBLC/en_US;FBBV/317607584;FBCR/null;FBMF/Safaricom;FBBD/Safaricom;FBDV/NEON_NOVA;FBSV/10;FBCA/arm64-v8a;]"
	...
	def method1(self,uid,nm,pwx):
		try:
			...
			for ps in pwx:
				...
				ua = "[FBAN/FB4A;FBAV/"+str(random.randint(10, 99))+".0.0."+str(random.randint(1000, 9999))+";FBBV/"+str(random.randint(1000000, 9999999))+";"+hehe()
